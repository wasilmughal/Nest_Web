  ...
  function SmallCards({title,image,price1,price2}) {
    return (
      <>
      <div class="p-2 h-[120px] w-full" id='FeaturedCategories'>
                <div class="h-full flex items-center border-gray-100 border p-2 rounded-lg">
                  <img
                    alt="team"
                    class="w-16 h-16 bg-gray-100 object-cover object-center  rounded-lg mr-4"
                    src={image}
                  />
                  <div class="flex-grow">
                    <h2 class="text-gray-900 text-[12px]  font-bold">
  {title}                  </h2>
                    ...
                    <div class=" items-center flex ">
                      ...
                      <p class="text-gray-500 text-xs ml-2">(4.0)</p>
                    </div>

                    <div className="mt-2">
                      <h1 className="text-[#3BB77E] font-bold text-[14px]">
                        {price1}
